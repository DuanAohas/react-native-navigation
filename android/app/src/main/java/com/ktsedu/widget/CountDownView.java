...
/**
 * Created by jdhaut on 2016/12/22.
 */
...
public class CountDownView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画居中的文字
         canvas.drawText("跳过", width / 2, height / 2 - textPaint.descent() + textPaint.getTextSize() / 2, textPaint);
...
//        staticLayout.draw(canvas);
    ...
    public void start() {
        ...
        CountDownTimer countDownTimer = new CountDownTimer(5000, 36) {
            @Override
            public void onTick(long millisUntilFinished) {
                progress = ((5000 - millisUntilFinished) / 5000f) * 360;
